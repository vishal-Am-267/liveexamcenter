...
export class ManageQuestionsService {
  ...
  getSubjectList() {
    ...
    const headers = { 'authorization': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2MTljZTRhOGU1ODY4NTE0NjEwYzhkYTUiLCJfYWN0aXZlT3JnIjoiNjE5Y2U0YThlNTg2ODUxNDYxMGM4ZGE3IiwiaWF0IjoxNjM3OTAxNTYzLCJleHAiOjE2Mzc5NDQ3NjN9.QQaxm51V70jwy4SmPu7U9yaRgZEp6jrzhDRdwabz-QA' }
